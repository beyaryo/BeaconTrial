package id.developer.lynx.cubeacontry.bluetooth.container;
...
import id.developer.lynx.cubeacontry.R;
import id.developer.lynx.cubeacontry.bluetooth.util.CsvWriterHelper;
import id.developer.lynx.cubeacontry.bluetooth.util.TimeFormater;
...
public class BluetoothDeviceStore {
    ...
    private String getListAsCsv() {
        ...
        for (final BluetoothLeDevice device : list) {
            ...
            sb.append(CsvWriterHelper.addStuff(TimeFormater.getIsoDateTime(device.getFirstTimestamp())));
            sb.append(CsvWriterHelper.addStuff(device.getFirstRssi()));
            sb.append(CsvWriterHelper.addStuff(TimeFormater.getIsoDateTime(device.getTimestamp())));
    ...
    public void shareDataAsEmail(final Context context) {
        ...
        final String subject = context.getString(
                ...
                TimeFormater.getIsoDateTime(timeInMillis));
