...
public class UtcDateFormater extends java.text.SimpleDateFormat {
    ...
    public UtcDateFormater(final String template) {
        super(template);
        super.setTimeZone(TIME_ZONE_UTC);
    }

    @SuppressLint("SimpleDateFormat")
    public UtcDateFormater(final String template, final DateFormatSymbols symbols) {
        super(template, symbols);
        super.setTimeZone(TIME_ZONE_UTC);
    }

    public UtcDateFormater(final String template, final Locale locale) {
